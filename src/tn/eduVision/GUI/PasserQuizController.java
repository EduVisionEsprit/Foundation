...
import tn.eduVision.services.NoteTestService;
...
public class PasserQuizController implements Initializable {
   ...
   private Quiz quiz ;
    ...
    public void setQuiz(Quiz q){
        if(q.getClass().getSimpleName().toLowerCase().equals("quiz")){
            ...
            NoteTestService ndao = new NoteTestService() ;
            NoteTest n = ndao.getNoteById(1,q.getId()); //currentUser.getId();//ps*
  ...
  /*timer*/  
    ...
    private void checkAnswers(){
        ...
        NoteTest n = new NoteTest(quiz.getId(), 1, note) ;//currentUser.getIdUtilisateur()
        NoteTestService ndao = new NoteTestService() ;
